    ...
    <Box border="1px" borderColor="teal.100" background="teal.50">
      <Grid templateColumns="repeat(3, 1fr)">
        ...
        <GridItem colStart={4} colEnd={6}>
          ...
          <Button m={2} fontSize={{ base: '15px', md: '18px', lg: '20px' }} align="right" colorScheme="purple" variant="solid" borderRadius="full" boxShadow="base" verticalAlign="right">Log Out</Button>
        </GridItem>
      </Grid>
    </Box>
  </>
